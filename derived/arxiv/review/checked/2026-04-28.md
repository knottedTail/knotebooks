...
### [x] Invariants from involutory Hopf algebras of 3-manifolds with embedded framed links
...
### [x] Equivalence of toral Chern-Simons and Reshetikhin-Turaev theories
...
### [x] Equivalence of Extended $U(1)$ Chern-Simons and Reshetikhin-Turaev TQFTs
...
### [x] Orthosymplectic quantum groups revisited
...
### [x] Lie Quandles, Leibniz Racks and Noether's First Theorem
...
### [x] The von Neumann algebraic quantum group $\mathrm{SU}_q(1,1)\rtimes \mathbb{Z}_2$ and the DSSYK model
...
### [x] Universal $T$-matrices for quantum Poincaré groups: contractions and quantum reference frames
...
### [x] On the classification of finite GK-dimensional pre-Nichols algebras and quasi-quantum groups
...
### [x] Reflections and Drinfeld twists for set-theoretic Yang-Baxter maps
...
### [x] Homomorphism Indistinguishability Relations induced by Quantum Groups
...
### [x] Almost finitary birepresentation theory and applications to affine Soergel bimodules
...
### [x] On skein algebras of planar surfaces
...
### [x] The minimal Rickard complexes of braids on two strands
