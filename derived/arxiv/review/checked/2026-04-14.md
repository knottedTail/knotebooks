...
### [x] Multiplicity of non-acyclic ${\rm SL}_2$-representations and L-functions of the odd-twisted Whitehead links
...
### [x] Quantum state transfer on a scalable network under unital and non-unital noise
...
### [x] Feynman's linear divergence problem
...
### [x] Wheel Classes in Kontsevich Graph Complex and Merkulov's Low-Valence Conjecture
...
### [x] Generalised 4d Partition Functions and Modular Differential Equations
...
### [x] Slope detection and toroidal 3-manifolds
